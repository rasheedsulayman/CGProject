...
import com.r4sh33d.cgproject.gl_engine.BasicPrimitiveGLSurfaceView;
import com.r4sh33d.cgproject.shapes.Polygon;

import timber.log.Timber;


public class BasicPrimitiveGLES20Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mGLView = new BasicPrimitiveGLSurfaceView(this , elementType, polygonConfig);
